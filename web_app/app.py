...
def generate_marketing_content(strengths, weaknesses):
    ...
    try:
        ...
        2–4 предложения, которые можно использовать в описании товара или рекламном объявлении.

        3. Ключевые преимущества
        5 коротких буллитов для карточки товара или инфографики.

        4. Короткий вариант для рекламы
        1–2 предложения для баннера, таргетированной рекламы или промопоста.

        5. Призыв к действию
        Одна короткая фраза, побуждающая купить или перейти к товару.
