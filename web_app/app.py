...
if st.session_state.page == "Главная":
    ...
    st.markdown("<p style='opacity: 0.6;'>Автоматически собираем отзывы с маркетплейсов и определяем потребности потребителей с помощью нейросетей</p>", unsafe_allow_html=True)
